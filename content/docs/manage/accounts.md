...
Jambo offers two account types for you to choose from:
...
- [Invite collaborators](/docs/guides/project-collaboration-guide) (other Jambo users) to the project
...
Here's where to go in the Jambo Console to complete these actions:

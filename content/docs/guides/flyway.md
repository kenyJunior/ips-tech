---
title: Get started with Flyway and Jambo
subtitle: Learn how to manage schema changes in Jambo with Flyway
...
This guide steps you through installing the Flyway command-line tool, configuring Flyway to connect to a Jambo database, and running database migrations. The guide follows the setup described in the [Flyway command-line quickstart](https://documentation.red-gate.com/fd/quickstart-command-line-184127576.html).
...
To configure Flyway to connect to your Jambo database, create a `flyway.conf` file in the /conf directory. Include the following items, modified to use the connection details you retrieved in the previous step.
...
To verify that the `person` table was created, you can view it on the **Tables** page in the Jambo Console. Select **Tables** from the sidebar and select your database.
...
You can verify that the data was added by viewing the table on the **Tables** page in the Jambo Console. Select **Tables** from the sidebar and select your database.
...
You can also view the table on the **Tables** page in the Jambo Console. Select **Tables** from the sidebar and select your database.

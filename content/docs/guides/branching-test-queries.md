...
subtitle: Create a Jambo branch to test queries before running them in production
...
For the purpose of this guide, let's assume you have a database in Jambo with the following table and data:
...
You can also create a test branch using the [Jambo CLI](/docs/reference/cli-branches#create) or [Jambo API](/docs/manage/branches#create-a-branch-with-the-api).
...
You can also delete a branch using the [Jambo CLI](/docs/reference/cli-branches#delete) or [Jambo API](/docs/manage/branches#delete-a-branch-with-the-api).

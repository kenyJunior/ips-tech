...
subtitle: Learn how to set up a Jambo database and connect from an AWS Lambda function
...
This guide describes how to set up a Jambo database and connect to it from an AWS Lambda function using Node.js as the runtime environment. It covers:
...
- Connecting your Lambda function to a Jambo database.
...
In this guide, you have learned how to set up a Postgres database using Jambo and connect to it from an AWS Lambda function using Node.js as the runtime environment. You have also learned how to use Serverless Framework to create and deploy the Lambda function, and how to use the `pg` library to perform a basic database read operations.

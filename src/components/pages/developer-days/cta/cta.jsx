...
const CTA = () => (
  <section className="safe-paddings cta sm:pt[190px] bg-black-pure pb-[366px] pt-[568px] text-white xl:pb-[258px] xl:pt-[408px] lg:pb-[226px] md:pb-36 md:pt-[364px] sm:pb-24 sm:pt-[190px]">
    <Container className="relative flex flex-col items-center" size="md">
      ...
      >
        ...
        />
        <span className="relative z-10">Try Jambo now</span>
      </Button>
    </Container>
  </section>
);

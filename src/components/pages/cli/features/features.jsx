...
const items = [
  {
    icon: workflowIcon,
    title: 'Your full Jambo workflow',
    description: 'Manage projects, databases, branches, roles, and&nbsp;more.',
    linkText: 'View all Jambo CLI commands',
    url: LINKS.cliReference,
  },
  {
    icon: scriptIcon,
    title: 'Script and automate',
    description: 'Use the Jambo CLI to script almost any&nbsp;action in&nbsp;Jambo.',
  ...
  },
  {
    icon: contributeIcon,
    title: 'Contribute',
    description: 'Jambo CLI is open source. Contribute&nbsp;to our GitHub&nbsp;repo.',
    linkText: 'Contribute to Jambo CLI',
  ...
  <section className="features safe-paddings my-20 md:my-16 sm:my-10">
    <Container size="960">
      <Heading
        ...
        tag="h2"
      >
        Cut out the clicks. Command Jambo Postgres from the terminal
      </Heading>
      <CardItemsList
